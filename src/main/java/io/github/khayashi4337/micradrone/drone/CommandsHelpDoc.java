...
public final class CommandsHelpDoc {
    ...
    public static final String COMMANDS = """
            ...
            plant("carrot")
                耕地にニンジンを植える。ショップでcarrotをアンロックするか、
                コントローラの持ち主が本物のニンジンの種を持っていないと
                失敗する（アンロックの方法はヘルプ(2/3)の「アンロックショップ」、
                種での代用はヘルプ(2/3)の該当節を参照）。
            ...
            plant("pumpkin")
                ...
                アンロックするか、持ち主が本物のカボチャの種を持っていないと
                失敗する（carrotと同じ）。
    ...
    public static final String ADVANCED = """
            ...
            （融合・収穫・手破壊の3つは大きいかぼちゃほど低い音になる）、
            実る時に腐ると煙とぐしゃっという音（こちらは大きさに関係なく一定）。
