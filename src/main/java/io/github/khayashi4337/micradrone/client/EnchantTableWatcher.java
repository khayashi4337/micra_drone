 ...
 * blank script scroll landing in it - the moment a player drops one in, same as dropping in any
 * other enchant target, swaps to the sample picker ({@code EnchantScrollScreen}). Vanilla's own
